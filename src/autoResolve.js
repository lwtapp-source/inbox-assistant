...
// Matches Fyxer's "a reply moves the thread out of To Respond" behavior — if the account
// owner has sent anything in an urgent thread since it was triaged (whether through our
// generated draft or sent directly in Gmail/Outlook), it no longer needs to sit on Top
// Priorities waiting for a manual "Done" click. Reuses findSentVersionInThread, built for
// the draft-learning feature — "was anything sent in this thread after X" is exactly what
